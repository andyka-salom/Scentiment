...
<head>
    ...
    <title>Form Ditutup — Heaven Scent</title>
...
<body class="font-sans antialiased min-h-screen flex items-center justify-center py-12 px-4">
    ...
    <div class="max-w-md w-full bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-slate-100/50 text-center">
        <!-- Closed Info Icon -->
        <div class="inline-flex p-4 bg-rose-50 text-rose-600 rounded-full mb-6">
        ...
        <h1 class="font-serif text-2xl font-bold text-charcoal mb-4">Form Ditutup</h1>
        
        <p class="text-slate-500 text-sm mb-6 leading-relaxed">
            Formulir ini tidak lagi menerima tanggapan baru. Silakan hubungi pembuat formulir untuk info lebih lanjut.
        </p>
    </div>
